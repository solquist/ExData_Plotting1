...
#
# Read in electric power consumption data and plot a time series of the three
# sub metering series for the two days 2007-02-01 through 2007-02-02 to
# Plot3.png.
#
...
# Create a time series of the three sub metering series and save as Plot3.png
# that is 480 x 480 (default for "png()"). Annotate with a legend for the three
# series. Sub_metering_1 has the largest values, so use it to set the initial
# plot size.
